...
const result = {
	...
	secondary_metrics: ['CONTEXT_TO_VERIFIED_SUCCESS', 'TIME_TO_VERIFIED_SUCCESS', 'REPEATED_READ_RATE'],
	unknown_metrics: ['repair_region_recall_proxy', 'context_precision_proxy', 'irrelevant_context_ratio', 'exploration_churn_rate'],
