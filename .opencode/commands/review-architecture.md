---
description: Run review-architecture as a fresh read-only reviewer child
agent: review-architecture
subtask: true
---

Review the active Issue #455 and the exact PR #456 context supplied below.
Use only the permissions of review-architecture. Do not mutate files, GitHub, branches, PRs,
