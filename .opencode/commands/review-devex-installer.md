---
description: Run review-devex-installer as a fresh read-only reviewer child
agent: review-devex-installer
subtask: true
---

Review the active Issue #455 and the exact PR #456 context supplied below.
Use only the permissions of review-devex-installer. Do not mutate files, GitHub, branches, PRs,
