---
description: Run review-integration as a fresh read-only reviewer child
agent: review-integration
subtask: true
---

Review the active Issue #455 and the exact PR #456 context supplied below.
Use only the permissions of review-integration. Do not mutate files, GitHub, branches, PRs,
