---
description: Run review-ux-accessibility as a fresh read-only reviewer child
agent: review-ux-accessibility
subtask: true
---

Review the active Issue #455 and the exact PR #456 context supplied below.
Use only the permissions of review-ux-accessibility. Do not mutate files, GitHub, branches, PRs,
