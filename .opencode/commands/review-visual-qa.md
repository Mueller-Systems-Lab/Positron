---
description: Run review-visual-qa as a fresh read-only reviewer child
agent: review-visual-qa
subtask: true
---

Review the active Issue #455 and the exact PR #456 context supplied below.
Use only the permissions of review-visual-qa. Do not mutate files, GitHub, branches, PRs,
