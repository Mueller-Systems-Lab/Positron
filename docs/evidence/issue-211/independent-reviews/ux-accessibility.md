...
**Non-blocking findings:** decorative dim text, a mobile-nav alternative, and icon semantics could be refined. No critical or major accessibility defect was reported; no browser or screen-reader execution occurred in this child.
