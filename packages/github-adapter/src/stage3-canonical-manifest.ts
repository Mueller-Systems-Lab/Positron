...
//
// Version: 3 — 2026-08-28 (Current Issue #308 validation target reconciliation.)
...
export const CANONICAL_FILE_CONTENT = [
	...
	'| Credential | Scoped GitHub runtime credential — value never persisted |',
	'| Merge | FORBIDDEN |',
	'',
	'## Purpose',
	'',
	...
	'## Validation Boundary',
	'',
	'Phase 4 failure-mode validation is bounded separately and must produce zero',
	'external mutations. This marker does not claim production, unsupervised, or',
	'release readiness.',
	'',
	'---',
...
export const CANONICAL_PR_BODY = [
	...
	.concat([
		...
		'- Approval Package: `docs/evidence/issue-308/phase3-current-approval-package.md`',
	])
	.join('\n');
...
export const CANONICAL_COMMIT_BODY = [
	...
	'- Scoped runtime credential value is never persisted and is removed after read-only verification',
].join('\n');
